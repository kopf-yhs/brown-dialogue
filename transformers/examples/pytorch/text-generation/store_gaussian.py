...
def main():
    ...
    with open(f'/convei_nas/yongho/BrownianDialogue/language_modeling_via_stochastic_processes/LM_{args.dataset_name}_{args.latent_dim}_density.pkl','wb') as f:
        pickle.dump([first_latent_mu,first_latent_std,last_latent_mu,last_latent_std], f)
